...
public static class GitHubHttpClientRegistrar
{
    ...
    {
        services.AddHttpClientCacheAsSingleton().TryAddSingleton<IGitHubHttpClient, GitHubHttpClient>();
    ...
    {
        services.AddHttpClientCacheAsSingleton().TryAddScoped<IGitHubHttpClient, GitHubHttpClient>();
